package dao.bookshelf;

import java.util.Arrays;
import java.util.HashSet;

import database.bookshelf.BookDatabaseHelper;
...
public class BookContentProvider extends ContentProvider {
	...
	private static final String AUTHORITY = "dao.bookshelf";
	...
	private void checkColumns(String[] projection) {
		String[] available = { BookTable.COLUMN_ID, BookTable.COLUMN_ISBN,
